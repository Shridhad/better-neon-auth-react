      ...
      <div className="w-full max-w-md animate-fade-in">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-100">
            {needsVerification ? 'Email Verification Required' : 'Welcome back'}
          </h1>
          <p className="text-gray-400 mt-2">
            {needsVerification ? 'Please verify your email to continue' : 'Sign in to your account'}
          </p>
        </div>
        ...
        <Card>
          {needsVerification ? (
            ...
            <div className="text-center space-y-4">
              <div className="mx-auto w-16 h-16 bg-yellow-600/20 rounded-full flex items-center justify-center">
                <svg className="w-8 h-8 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                </svg>
              </div>
              <div className="space-y-2">
                <h2 className="text-xl font-semibold text-gray-100">Email Not Verified</h2>
                <p className="text-gray-400 text-sm">
                  Your account <span className="text-gray-200 font-medium">{email}</span> exists but the email address has not been verified yet.
                </p>
                <p className="text-gray-500 text-sm">
                  Please check your inbox for a verification link and click it to activate your account.
                </p>
              </div>
